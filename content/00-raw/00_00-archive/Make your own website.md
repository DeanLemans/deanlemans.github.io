...
You know what's easier than writing HTML? Writing plain text. You know what web servers are perfectly happy to serve? A [plain text web site](https://jsrn.net/plain-text-website.txt).
...
I've come to favour fewer, deeper interactions over a larger number of shallower ones, even if those likes *do* feel good. I'm not writing this to make myself out as the wise person who's transcended the shallowness of social media. I'm writing it because it takes a deliberate effort for me not to fall into those traps. There's some effort to [recreate “likes” in the IndieWeb](https://indieweb.org/like), but at the moment I view the lack of likes as more of a feature than a bug.
