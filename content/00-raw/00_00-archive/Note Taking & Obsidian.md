...
- get better at search. See [this video](https://www.youtube.com/watch?v=WqKluXIra70&list=WL&index=15&t=5780s), min 54. investigate obsidian search syntax.
...
Link to relevant info. can be other notes, can be any link to whatever. I can link either using hyperlinks in the body or do it in a 'paper' kind of way where on the body it would list with [footer](https://andresestrella.vercel.app/404) and down in this section would be the link or acclaration.
...
- modify image size: `200px`
- type `[[^` to search and select a block of text on any file
- for more specific type `[[filename^]]`
