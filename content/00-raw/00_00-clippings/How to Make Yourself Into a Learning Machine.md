...
![](https://substackcdn.com/image/fetch/$s_!scT9!,w_1456,c_limit,f_webp,q_auto:good,fl_progressive:steep/https%3A%2F%2Fbucketeer-e05bbc84-baa3-437e-9518-adb32be77984.s3.amazonaws.com%2Fpublic%2Fimages%2F4a93d5eb-360d-4562-870b-b81952127026_1400x382.png)
...
![](https://substackcdn.com/image/fetch/$s_!Aecx!,w_1456,c_limit,f_webp,q_auto:good,fl_progressive:steep/https%3A%2F%2Fbucketeer-e05bbc84-baa3-437e-9518-adb32be77984.s3.amazonaws.com%2Fpublic%2Fimages%2F30f8839e-1189-4025-9272-ca740a8a0b89_1400x1092.png)
...
![](https://substackcdn.com/image/fetch/$s_!jMFB!,w_1456,c_limit,f_webp,q_auto:good,fl_progressive:steep/https%3A%2F%2Fbucketeer-e05bbc84-baa3-437e-9518-adb32be77984.s3.amazonaws.com%2Fpublic%2Fimages%2F7a91a4e2-b5ba-4eb1-b6b2-c41a553f7ae2_1400x814.png)
...
For example, take Reagan. If you know when he was president, you can say, *Okay this was around the Cold War and it was towards the end of it, and his platform supported trickle down economics which was a very important idea in that time period.*

Memorizing these things means that if you’re talking about the U.S. in the 80s, you’ll remember that he was president, and all of those concepts come up.
...
![](https://substackcdn.com/image/fetch/$s_!rqv_!,w_1456,c_limit,f_webp,q_auto:good,fl_progressive:steep/https%3A%2F%2Fbucketeer-e05bbc84-baa3-437e-9518-adb32be77984.s3.amazonaws.com%2Fpublic%2Fimages%2F027c4fc5-a5a6-458e-816c-4d4f895c636b_1085x1600.png)
...
I expect most of these projects to take years, decades, and some of them I’ll be working on for the rest of my life. I run [a script](https://github.com/sirupsen/dotfiles/blob/master/home/.bin/open-productive) when I have a few minutes that helps make little bursts of progress by choosing a random one of these areas.
...
Since English isn’t my first language, I sometimes run into words while I’m reading that I don’t understand. So to learn more words, I created a script that takes words from Readwise, and then automatically adds the audio pronunciation, the definition, and examples in a sentence to an [Airtable](https://every.to/c/airtable).

I then take these words and put them manually into Anki to help me learn them.

I did run into a problem with this approach: I ended up using words that no one knew. I would take a word from a 19th century novel, and then insert it into everyday conversation. No one would have any idea what I was talking about.
...
Recently, a friend was raving about the [reMarkable tablet](https://remarkable.com/), and I now use for reading those types of documents a fair bit. It’s a simple e-ink tablet. It’s larger than the Kindle, and feels like paper when you write. It doesn’t replace your Kindle. It’s not good for long-form.

Categories of content that I just didn’t read before are now a pleasure to sink into a chair with.

Most of the Google Docs and longer emails (I often use a [10 minute mail](https://10minute-email.com/) as a service) I review, I send to my reMarkable and process there.
