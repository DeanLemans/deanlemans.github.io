...
1. capture stage
1.1 reference (if aplicable) where it came from
2. process stage
3. permanent note/atomic
4. evergreen/zettel
5. written piece/project

that's kinda the idea, but it's more like a flow graph then a linear line