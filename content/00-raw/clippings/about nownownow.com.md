...
*“Any time I’m in something that kind of feels useful or fun, but isn’t clearly aligned with my bigger goals, I pull up my now page and ask ‘Is it on there? Should I add it?’ Most of the time the answer is no, and I move on. Sometimes it’s yes, and when it is, at least it’s an intentional priority shift.”* — [Gregory Brown](https://practicingdeveloper.com/now/)

## So what is nownownow.com?

After a few people added a /now page to their site — ([see original story](https://sive.rs/nowff)) — Greg Albritton suggested we keep **a collection of everyone that has a /now page**.

That’s all this is. It’s not a business. It’s not social media.

[See the announcement and story here](https://sive.rs/now3).

## How do I get listed on nownownow.com?

**If your website already has a /now page on it**, as described and defined above, just [email the URL to me](https://sive.rs/contact). After you do, I’ll email you back with a link to log in and answer a few questions, which creates your profile here.

## How do I make a now page?

**If you already have a website, but don’t have a /now page**, just add a new page. (For WordPress and Wix, [see my instructions](https://sive.rs/now2).)

Write something about what you’re doing now, and publish. Once it’s online, email me the URL.

**If you don’t have a website**, but have been meaning to get one, create a free one at [BearBlog.dev](https://bearblog.dev/). Before you announce it, I highly recommend getting your own domain name at [porkbun.com](https://www.porkbun.com/). Point your domain to your Bear blog, and use that.

## Can we add our business here?

No. Browsing [nownownow.com](https://nownownow.com/) is only interesting because you get a glimpse into people’s lives and how they focus.
...
[Derek Sivers](https://sive.rs/). That’s me.

I’m just doing this because people asked me to.[Email me](https://sive.rs/contact) with any questions or suggestions.