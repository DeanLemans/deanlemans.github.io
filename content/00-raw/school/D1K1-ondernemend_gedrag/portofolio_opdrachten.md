...
## 1. Maak een Profiel van jezelf

### Capaciteiten en ambities

- **Waar ben je goed en minder goed in?**
  Denk aan BPV, werk, opleiding, hobby of sportvereniging.
	1. ik hou van mijn goed done ben hou van lezen en tuinieren
- **Waar weet je veel van en wat zou je graag willen leren?**
  Beschrijf je ambities.
- **Hoe wil je dat anderen jou zien?**
	1. ligt eraan wie, vrienden en famillie(some kennisen), gewoon also mezelf.
	2. bij een profesionele stelling(klanten), (belangrijke) gesprekken wil dat ik prosesioneeler overkom.

### Motivatie en gedrag

- **Waar geloof je in en wat drijft je?**
	1. ik geloof in mezelf, en ik wil invloed/meer willen zijn via doen wat ik leuk en/of volvullend en/of better kan worden/vinden.
- **Welke werkzaamheden op je werk vind je leuk en minder leuk?**
	1. Leuk;
...
- **Hoe ga je om met werkzaamheden die je minder leuk vindt of minder goed kan?**
	1. also ik het minder goed kan ga ik vragen hoe/wat ik better kan doen
	2. also ik het niet leuk vind; dat zou eraan liggen of ik het gewoon een beetje saai vind of ik het haat.
		1. saai/minder leuk/niet favoriet;
			1. dan ga ik het gewoon doen, en probeer het leuker voor mezelf te maken(muziek, ander werk manier)
		2. haat/niet leuk;
			1. vraag ik of ik iets anders kan doen.
- **Neem je initiatief in het zelf vinden van oplossingen of wacht je eerst op anderen?**
	1. als het iets nieuws is dan vraag ik eerst hoe het moet en dan doe ik het zelf, daarna vraag ik of ik het goed doe en hoe ik het nog beter kan doen.
	2. iets waar ik minder ervaring mee heb; doe ik het en daarna vraag ik of ik het goed doe.

### Rol en rolmodellen

- **Wie zijn je grote voorbeelden en waarom?**
	1. niemand? friedrich nietsche, anna goldman
  Wat bewonder je in hen?
	2. X
...
- **Waarom heb je voor deze BPV, werk, opleiding, hobby of sportvereniging gekozen?**
- **Zou je dezelfde keuze opnieuw maken? Waarom well of niet?**
1. ik zou in fucking crypto investeren
...
Beschrijf kort wat ondernemend gedrag volgens jou is:
1. profesioneel werken? goed werken? sociaal zijn?/

### Rubric ondernemend gedrag

- Bekijk de bijlage met de rubric ondernemend gedrag.
- **Geef per regel aan op welk niveau je presteert.**
- **Leg uit:**
  - Wat kun je al (heel erg) goed?
  - Wat kun je nog verbeteren?

### Vergelijking met je begeleider

- Vraag je begeleider om de rubric ook in te vullen.
- Vergelijk jullie antwoorden.

### Analyse van je ondernemend gedrag

- **Vind je dat je vaak ondernemend gedrag vertoont? Waarom well of niet?**
1. well;
2. nie;
	1. ligt ernaan waar, bij sommige bijbanen kom ik telaat, maar da doe ik meestal naardat ik vertrouwen heb opgebouwd dat ik mijn werk goed doe.
	2. iets profesioneeler zijn
	3. iets sociaaler zijn
	4. verzorgder uitzien
- **Voorbeelden van ondernemend gedrag:**
  Beschrijf situaties waarin jij ondernemend was.
- **Welke omstandigheden heb jij nodig om ondernemend te zijn?**
- **Wat heb je nodig om ondernemender te worden?**
  Geef aan op welke onderdelen jij je nog wilt ontwikkelen.
- **Wat wil je verder nog leren** om je BPV, werk, opleiding, hobby of sport better uit te voeren?
	1. snelheid
	2. qualiteid
	3. scaling? meervoudheid?

## 3. Je Omgeving

Voor deze opdracht onderzoek je jouw eigen omgeving. Dit kan je BPV, werk, opleiding, hobby of sportvereniging zijn. Voor deze omgeving/organisatie ga je straks een verbetervoorstel uitwerken. Overleg met je begeleider welke omgeving je het beste kunt kiezen.


> [!question]- zou ik het voor meerdere doen?
> mischien vragen aan iedereen bij wie ik werk.
...
- Welke regels, normen en kernwaarden gelden er. Hoe gaan jullie met elkaar om?
- Welke ontwikkelingen en trends zijn belangrijk voor de omgeving/organisatie?
...
Beantwoord in je logboek de volgende vragen:
...
- [ ] Bewijsstukken
- [ ] een eerste versie van je profiel
- [ ] een definitieve versie van je profiel
- [ ] een verslag/vlog over hoe ondernemend je bent
- [ ] een verslag/vlog over je omgeving/organisatie
- [ ] een plan van aanpak voor je persoonlijke ontwikkeling
- [ ] een actueel logboek
