...
## Collect chapters I liked and bookmarked
...
Currently using Musicolet, which is unfortunately proprietary, on GrapheneOS/Android, because it's the only proper one.

I used Tauon for a time, but it's not yet mature enough, and I like the UI of Strawberry more.

Currently using Tauon for laptop, but it's not mature enough, so I'm going to be switching to Strawberry or Clementine.
...
3. [Wondershare Filmora](https://filmora.wondershare.com)
4. [Clipchamp](https://clipchamp.com), browser based
5. [Shotcut](https://shotcut.org)
6. Librecut, browser based
...
So, I was thinking of switching to a ball-pointer mouse, a drawing tablet, or a fully customizable (Framework?) mouse.

Write down what the needs and restrictions of my current platform are.

Maybe a configurable mouse? With trackball? And programmable buttons?

Or maybe replace it entirely with a drawing tablet, would be more versatile.
...
This one is the most customizable, but lacks intermediate features (autocomplete, swipe typing). And if you don't need that, then this is absolutely the perfect keyboard.

## FUTO Keyboard

Meager customizability compared to FlorisBoard, has great swipe typing, and autocomplete.
...
# Dean's guidelines for school

1. Make connections
2. Learn
3. Have fun

How? Idk bro, just talk to people I guess, but don't be overbearing.

---

# Research reliable/long term car engines

Toyota 1HZ, legendary 4.2L inline-6 diesel. Gear-driven plus a tiny belt you could change blindfolded. No turbo, no drama. Just runs.

Nissan TD42, another 4.2L monster. Gear-driven timing, available NA or turbo. Simple and stupidly tough.
...
Opel C24NE, 2.4L gas 4-cylinder. Iron block, iron head. Ultra-basic design equals huge lifespan.

Mercedes OM314, old-school 3.8L industrial diesel. 4-cylinder, gear-driven cam, no turbo. Tiny footprint, giant heart.

This list sticks to fully cast-iron engines only. There are plenty of other legendary "million-mile" motors out there with aluminum heads (but those aren't really meant to last a million miles).