...
cant use a van, for freelance related activities, as it has to be registered for work if i want to use it for work?
it will be suspicious either way, if i work with it and live in it.
and also when i only use it for living (as people seeing a random white van going from place to place)
...
maybe something like my name and ads to the van.

If there is an accident with the van during work use, there is a higher possibility of an insurance claim being denied
