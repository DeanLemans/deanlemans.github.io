...
- Aligns with [file over app](https://stephango.com/file-over-app) and [Manifesto - Preserving Content on the Web](<./00-raw/00_00-archive/external/This Page is Designed to Last A Manifesto for Preserving Content on the Web.md>).
